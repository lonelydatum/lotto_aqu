...
(0, _commonJsCommonJs.start)("D_MB");
...
function csl() {
	...
	tl_4.to([".csl_2", ".csl_3"], scale_time, { scale: .88, opacity: .3, ease: Power1.easeOut }, 0);
	tl_4.to(".csl_3 .red", .1, { opacity: 0 }, 0);
	tl_4.to(".csl_3 .black", .1, { opacity: 1 }, 0);
	tl_4.add(csl_fade(".csl_2"));
	tl_4.to([".csl_2", ".csl_3"], scale_time, { scale: 1, opacity: 1, ease: Power1.easeOut });
